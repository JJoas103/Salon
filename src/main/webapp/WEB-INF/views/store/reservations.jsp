...
<body>
  <aside class="sidebar">
    ...
    <ul class="sidebar-menu">
      <li class="sidebar-item active"><a href="reservations.html"><i class="fas fa-calendar-check"></i> 예약현황관리</a></li>
      <li class="sidebar-item"><a href="staff.html"><i class="fas fa-users"></i> 직원관리</a></li>
      <li class="sidebar-item"><a href="store.html"><i class="fas fa-store"></i> 매장정보 관리</a></li>
