...
<head>
  ...
  <title>HAIR RESERVE | 예약 캘린더</title>
...
<body>
    ...
    <main class="app-content">
      ...
      <section class="calendar-card">
        <header class="calendar-page-header">
          ...
          <div class="view-switcher" role="group" aria-label="캘린더 보기 방식">
            <button type="button"
                    id="monthViewButton"
        ...
        <section id="listView" class="hidden">
          <div class="list-toolbar">
            <div class="list-month-navigation">
              ...
              <strong id="listMonthTitle" class="list-month-title"></strong>
  ...
  <div id="reservationModal"
    ...
    <div id="modalBackdrop" class="reservation-modal-backdrop"></div>

    <div class="reservation-modal-content">
      <div class="reservation-modal-header">
        <div>
          <span id="modalStatus" class="modal-status"></span>
          <h2 id="modalServiceName">예약 상세</h2>
        </div>
