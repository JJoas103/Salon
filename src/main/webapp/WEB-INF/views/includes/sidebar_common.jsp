...
<aside class="sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <li class="sidebar-item ${menu == 'search' ? 'active' : ''}" data-protected="true"><a href="<c:url value='/common/search'/>"><i class="fas fa-search"></i> 헤어샵 검색/예약</a></li>
    ...
    <li class="sidebar-item ${menu == 'popular' ? 'active' : ''}" data-protected="true"><a href="<c:url value='/common/community/popular'/>"><i class="fas fa-fire"></i> 인기글</a></li>
